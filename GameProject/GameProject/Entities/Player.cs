...
namespace GameProject
{
    class Player
    {
        ...
        public Player(ContentManager _content, Remote _remote)
        {
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            //spriteBatch.Draw(texture, position, rectangle, Color.White, 0f, new Vector2(0, 0), 3f, SpriteEffects.None, 1);
